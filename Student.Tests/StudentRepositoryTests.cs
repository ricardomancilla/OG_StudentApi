...
namespace Student.Tests
{
    public class StudentRepositoryTests
    {
        ...
        public async Task GetAllAsync_ReturnsListOfStudents()
        {
            ...
            IEnumerable<DataAccess.Model.Student> actual = await studentRepositoryMock.Object.GetAllAsync();
        ...
        public async Task CreateAsync_ReturnsCreatedStudentId()
        {
            ...
            int actual = await studentRepositoryMock.Object.CreateAsync(It.IsAny<DataAccess.Model.Student>());
        ...
        public async Task UpdateAsync_StudentExists_ReturnsTrue()
        {
            ...
            bool actual = await studentRepositoryMock.Object.UpdateAsync(It.IsAny<DataAccess.Model.Student>());
        ...
        public async Task DeleteAsync_StudentExists_ReturnsTrue()
        {
            ...
            bool actual = await studentRepositoryMock.Object.DeleteAsync(It.IsAny<int>());
